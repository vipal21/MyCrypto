...
class DeveloperPreview {
    ...
    let statistc1 = StatistcModel(title: "Market Cap", value: "$12.5Bn",percentageChange: 25.43)
    let statistc2 = StatistcModel(title: "Total Volume", value: "$1.5Bn")
    let statistc3 = StatistcModel(title: "Portfolio Value", value: "$12.5Bn",percentageChange: -2.76)
